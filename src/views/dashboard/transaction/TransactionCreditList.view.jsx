...
import TransactionCreditListContainer from 'apps/containers/Dashboard/Transaction/TransactionCreditList.container';
  ...
  return (
    <>
      ...
      <DashboardLayout t={t} history={history}>
        <TransactionCreditListContainer t={t} history={history} location={location} />
      </DashboardLayout>
    </>
  );
};
