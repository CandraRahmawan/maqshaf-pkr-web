...
import SearchProductContainer from 'apps/containers/Shop/SearchProduct.container';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content={t('search_product:metaDescription')} />
      </Helmet>
...
export default withTranslation(['search_product', 'glossary'])(SearchProductView);
