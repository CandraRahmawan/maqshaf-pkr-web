!(function (e) {
  ...
  function (e, t, n) {
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 27:
                      return (
                        o || (u = u && 200 === u.status ? u : void 0), e.abrupt('return', u || null)
                      );
                    case 29:
                    case 'end':
                      return e.stop();
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 3:
                      return (
                        (s = e.sent), (e.next = 6), A({ plugins: o, request: r, mode: 'read' })
                      );
                    case 6:
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        ...
                        break;
                      case 4:
                        return (e.next = 6), A({ plugins: o, request: r, mode: 'write' });
                      case 6:
                        if (((f = e.sent), a)) {
                          e.next = 10;
                          break;
                      ...
                      case 18:
                        ...
                        return (e.next = 23), C({ cacheName: n, matchOptions: s, request: f });
                      case 23:
                          ...
                          case 2:
                            return (
                              ...
                              new Promise(function (e, n) {
                                ...
                                setTimeout(function () {
                                  (r = !0),
                                    n(new Error('The open request was blocked and timed out'));
                                }, t.OPEN_TIMEOUT);
                                ...
                                (a.onerror = function () {
                                  ...
                                  (a.onsuccess = function () {
                                    ...
                                    r
                                      ? n.close()
                                      : ((n.onversionchange = t._onversionchange.bind(t)), e(n));
                                  });
                              })
                            );
                          case 4:
                  ...
                  return L.a.wrap(
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (e.next = 2), this.getAllMatching(t, { query: n, count: r });
                          case 2:
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.next = 2),
                              this.getAllMatching(t, { query: n, count: r, includeKeys: !0 })
                            );
                          case 2:
                            return (
                              (a = e.sent),
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              ...
                              (f = void 0 !== s && s),
                              (e.next = 3),
                              this.transaction([t], 'readonly', function (e, n) {
                  ...
                  return L.a.wrap(
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            for (a = o.length, i = new Array(a > 3 ? a - 3 : 0), c = 3; c < a; c++)
                              i[c - 3] = o[c];
                            return (
                              (u = function (e, r) {
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                for (
                                  a = u.length, i = new Array(a > 1 ? a - 1 : 0), c = 1;
                                  c < a;
                                  c++
                                )
                                  i[c - 1] = u[c];
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 55:
                        ...
                        return (
                          (e.next = 60),
                          b.fetchDidSucceed.call(b, { event: a, request: y, response: m })
                        );
                      case 60:
                        m = e.sent;
                      case 62:
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (
                                (e.next = 2),
                                this._db.transaction(z, 'readwrite', function (e, r) {
                                  var a = e
                                      .objectStore(z)
                                      .index('timestamp')
    ...
    function ae(e) {
      ...
      return i.searchParams.set('__WB_REVISION__', n), { cacheKey: i.href, url: c.href };
    }
    var ie,
      ce = (function () {
        function e(t) {
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 4:
                              ...
                              return (
                                (e.next = 10),
                                h.cacheWillUpdate({ event: i, request: s, response: f })
                              );
                            case 10:
                            ...
                            case 14:
                              ...
                              throw new g('bad-precaching-response', { url: r, status: f.status });
                            case 17:
                              if (!f.redirected) {
                                e.next = 21;
                                break;
                        ...
                        function (n) {
                          for (;;)
                            switch ((n.prev = n.next)) {
                              case 0:
                                return (
                                  (a = r.request), (n.prev = 1), (n.next = 4), e.matchPrecache(a)
                                );
                              case 4:
                                if (!(i = n.sent)) {
                                  n.next = 7;
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (a.protocol.startsWith('http')) {
                  var i = this.findMatchingRoute({ url: a, request: n, event: r }),
                    c = i.params,
                    u = i.route,
                    o = u && u.handler;
                    ...
                    return (
                      s instanceof Promise &&
                        ...
                        (s = s.catch(function (e) {
                          return t._catchHandler.handle({ url: a, request: n, event: r });
                        })),
                      s
                    );
                  }
                          ...
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (
                                ...
                                (a = this._getFromNetwork({ request: r, event: n })),
                                (e.next = 7),
                                K.match({
                                  cacheName: this._cacheName,
                                  request: r,
                            ...
                            case 23:
                              ...
                              throw new g('no-response', { url: r.url, error: c });
                            case 26:
    ...
    self.addEventListener('activate', function () {
      ...
      (function (e) {
        ...
        { revision: 'ab7b37ac4211e36c0a6428bc1abe0c91', url: '/index.html' },
        { revision: null, url: '/static/css/11.631f7a65.chunk.css' },
        { revision: null, url: '/static/css/main.9a18e241.chunk.css' },
        { revision: null, url: '/static/js/0.bd83eee3.chunk.js' },
        { revision: null, url: '/static/js/1.fc5dc75d.chunk.js' },
        { revision: null, url: '/static/js/11.40f7adfb.chunk.js' },
        { revision: null, url: '/static/js/12.a6d41230.chunk.js' },
        { revision: null, url: '/static/js/13.337216e2.chunk.js' },
        { revision: null, url: '/static/js/14.9e1efe7b.chunk.js' },
        { revision: null, url: '/static/js/15.2445076d.chunk.js' },
        { revision: null, url: '/static/js/16.b7efc7b8.chunk.js' },
        { revision: null, url: '/static/js/17.ab5af16a.chunk.js' },
        { revision: null, url: '/static/js/18.9cc046f8.chunk.js' },
        { revision: null, url: '/static/js/19.39c0e3d1.chunk.js' },
        { revision: null, url: '/static/js/2.60dd5570.chunk.js' },
        { revision: null, url: '/static/js/20.08310e55.chunk.js' },
        { revision: null, url: '/static/js/21.0d63448d.chunk.js' },
        { revision: null, url: '/static/js/22.f9bfb8d8.chunk.js' },
        { revision: null, url: '/static/js/23.26bca9be.chunk.js' },
        { revision: null, url: '/static/js/24.36ad5fe8.chunk.js' },
        { revision: null, url: '/static/js/25.df207633.chunk.js' },
        { revision: null, url: '/static/js/26.5b4588c2.chunk.js' },
        { revision: null, url: '/static/js/27.9ed16139.chunk.js' },
        { revision: null, url: '/static/js/28.ad98b1f0.chunk.js' },
        { revision: null, url: '/static/js/29.6e859b91.chunk.js' },
        { revision: null, url: '/static/js/3.e551a722.chunk.js' },
        { revision: null, url: '/static/js/30.f4a4ce9d.chunk.js' },
        { revision: null, url: '/static/js/31.95d554a2.chunk.js' },
        { revision: null, url: '/static/js/32.aacb4ab4.chunk.js' },
        { revision: null, url: '/static/js/33.6e74d7f9.chunk.js' },
        { revision: null, url: '/static/js/34.2072987d.chunk.js' },
        { revision: null, url: '/static/js/35.ec0c119e.chunk.js' },
        { revision: null, url: '/static/js/36.d9113236.chunk.js' },
        { revision: null, url: '/static/js/4.fe1462e0.chunk.js' },
        { revision: null, url: '/static/js/5.9074e148.chunk.js' },
        { revision: null, url: '/static/js/6.2cea93ea.chunk.js' },
        { revision: null, url: '/static/js/7.96f7fcbe.chunk.js' },
        { revision: null, url: '/static/js/8.87e87457.chunk.js' },
        { revision: null, url: '/static/js/main.32ea1d04.chunk.js' },
        { revision: null, url: '/static/js/runtime-main.7d45321e.js' },
