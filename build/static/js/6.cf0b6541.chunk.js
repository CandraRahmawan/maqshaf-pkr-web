  ...
  [6],
  {
              ...
              a.createElement(
                "span",
                {
                  className: Object(i.a)(
                    s.startIcon,
                    s["iconSize".concat(Object(l.a)(T))]
                  ),
                },
                R
              ),
            ...
            Object(n.a)(
              {
                className: Object(i.a)(
                  ...
                  "inherit" === p
                    ? s.colorInherit
                    : "default" !== p && s["".concat(_).concat(Object(l.a)(p))],
                  "medium" !== T && [
                    s["".concat(_, "Size").concat(Object(l.a)(T))],
                    s["size".concat(Object(l.a)(T))],
                  ],
                ...
                disabled: v,
                focusRipple: !g,
                focusVisibleClassName: Object(i.a)(s.focusVisible, P),
                ref: t,
                type: E,
              },
              L
            ),
            a.createElement("span", { className: s.label }, O, r, I)
          );
        });
      t.a = Object(s.a)(
        function (e) {
      ...
      var o = r(1),
        ...
        c = a.forwardRef(function (e, t) {
          var r = e.classes,
            ...
            c = e.dividers,
            d = void 0 !== c && c,
            l = Object(n.a)(e, ["classes", "className", "dividers"]);
          return a.createElement(
            "div",
            Object(o.a)(
              { className: Object(i.a)(r.root, s, d && r.dividers), ref: t },
              l
            )
          );
        });
      ...
      var o = r(1),
        ...
        c = a.forwardRef(function (e, t) {
          var r = e.disableSpacing,
            ...
            c = e.classes,
            d = e.className,
            l = Object(n.a)(e, ["disableSpacing", "classes", "className"]);
          return a.createElement(
            "div",
            Object(o.a)(
              { className: Object(i.a)(c.root, d, !s && c.spacing), ref: t },
              l
            )
          );
        });
    ...
    189: function (e, t, r) {
      ...
      var s = r(0),
        ...
        l = r(190),
        u = l.getDeviceId,
        p = (l.getFacingModePattern, r(192)),
        f = r(193);
      r(196);
      var m = f(
          [
    ...
    190: function (e, t, r) {
      "use strict";
      var o = r(191).NoVideoInputDevicesError;
      function n(e, t, r) {
        return e.length > 0
          ? e[0].deviceId
          : 1 == t.length || "user" == r
    ...
    191: function (e, t, r) {
      ...
      (o.prototype = new Error()),
        (e.exports = { NoVideoInputDevicesError: o });
    },
    192: function (e, t, r) {
      "use strict";
      ...
      e.exports = function (e, t) {
        ...
        Object.defineProperty(l.prototype, "localDescription", {
              ...
              (this.transceivers[r].bufferedCandidateEvents = null),
                ...
                (a.onlocalcandidate = function (e) {
                  if (!(n.usingBundle && r > 0)) {
                    ...
                    var l = o.getMediaSections(n._localDescription.sdp);
                    (l[i.candidate.sdpMLineIndex] += c
                      ? "a=end-of-candidates\r\n"
                      : "a=" + i.candidate.candidate + "\r\n"),
                      (n._localDescription.sdp =
                        o.getDescription(n._localDescription.sdp) + l.join(""));
          ...
          (l.prototype.setLocalDescription = function (e) {
            ...
            if (
              !i("setLocalDescription", e.type, n.signalingState) ||
              n._isClosed
            )
              return Promise.reject(
                c(
            ...
            if ("offer" === e.type)
              ...
              t.forEach(function (e, t) {
                ...
                if (
                  !(
                    o.isRejected(e) &&
                    0 === o.matchPrefix(e, "a=bundle-only").length
                  ) &&
                  !i.rejected
                ) {
                  ...
                  s && (m.role = "server"),
                    (n.usingBundle && 0 !== t) ||
                      (n._gather(i.mid, t),
                      "new" === d.state &&
                        d.start(c, f, s ? "controlling" : "controlled"),
          ...
          (l.prototype.setRemoteDescription = function (n) {
            ...
            if (
              !i("setRemoteDescription", n.type, l.signalingState) ||
              l._isClosed
            )
              return Promise.reject(
                c(
            ...
            l.usingBundle = v;
            var k = o.matchPrefix(m, "a=ice-options:")[0];
            return (
              (l.canTrickleIceCandidates =
                !!k && k.substr(14).split(" ").indexOf("trickle") >= 0),
              f.forEach(function (i, c) {
                var d = o.splitLines(i),
                  f = o.getKind(i),
                  k =
                    o.isRejected(i) &&
                    0 === o.matchPrefix(i, "a=bundle-only").length,
                  C = d[0].substr(2).split(" ")[2],
                  B = o.getDirection(i, m),
                  g = o.parseMsid(i),
                  y = o.getMid(i) || o.generateIdentifier();
                if (
                  k ||
                  ("application" === f &&
                    ("DTLS/SCTP" === C || "UDP/DTLS/SCTP" === C))
                )
                  l.transceivers[c] = {
                    mid: y,
                    kind: f,
                  ...
                  var _,
                    L,
                    O = o.parseRtpParameters(i);
                  k ||
                    ((_ = o.getIceParameters(i, m)),
                    ((L = o.getDtlsParameters(i, m)).role = "client")),
                    (x = o.parseRtpEncodingParameters(i));
                  var I = o.parseRtcpParameters(i),
                    D = o.matchPrefix(i, "a=end-of-candidates", m).length > 0,
                    j = o
                  ...
                  if (
                    ...
                    if ("answer" === n.type && !k) {
                      (w = (P = l.transceivers[c]).iceGatherer),
                        (b = P.iceTransport),
                        (S = P.dtlsTransport),
                        (T = P.rtpReceiver),
                        ...
                        j.length &&
                          ...
                          ((!h && !D) || (v && 0 !== c)
                            ...
                            : b.setRemoteCandidates(j)),
                        (v && 0 !== c) ||
                          ("new" === b.state && b.start(w, _, "controlling"),
                          "new" === S.state && S.start(L)),
                        !a(
                          P.localCapabilities,
                          ...
                          : ((M = T.track),
                            g
                              ? (u[g.stream] ||
                                ...
                                r(M, u[g.stream]),
                                p.push([M, T, u[g.stream]]))
                              : (u.default || (u.default = new e.MediaStream()),
                                r(M, u.default),
                                p.push([M, T, u.default])));
                    }
                  } else {
                    ((P = l.transceivers[c] || l._createTransceiver(f)).mid =
                      y),
                      P.iceGatherer ||
                        (P.iceGatherer = l._createIceGatherer(c, v)),
                      j.length &&
                        ...
                        (!D || (v && 0 !== c)
                          ...
                          : P.iceTransport.setRemoteCandidates(j)),
                    ...
                    if ("sendrecv" === B || "sendonly" === B) {
                      if (
                        ...
                        (T =
                          P.rtpReceiver ||
                          new e.RTCRtpReceiver(P.dtlsTransport, f)),
                        A)
                      )
                        (M = T.track),
                          (g && "-" === g.stream) ||
                            (g
                              ...
                              : (u.default || (u.default = new e.MediaStream()),
                                (N = u.default))),
                          N &&
                            (r(M, N), P.associatedRemoteMediaStreams.push(N)),
                          p.push([M, T, N]);
                    } else
                      P.rtpReceiver &&
                        P.rtpReceiver.track &&
                    ...
                    (P.localCapabilities = E),
                      (P.remoteCapabilities = O),
                      (P.rtpReceiver = T),
                      (P.rtcpParameters = I),
                      (P.sendEncodingParameters = R),
                      (P.recvEncodingParameters = x),
                      l._transceive(l.transceivers[c], !1, A);
                  }
                }
              }),
              void 0 === l._dtlsRole &&
                (l._dtlsRole = "offer" === n.type ? "active" : "passive"),
              (l._remoteDescription = { type: n.type, sdp: n.sdp }),
              "offer" === n.type
          ...
          (l.prototype.createOffer = function () {
            ...
            var d = o.writeSessionBoilerplate(
              r._sdpSessionId,
            ...
            r.transceivers.forEach(function (n, a) {
              ...
              (n.mid = c),
                n.iceGatherer ||
                  (n.iceGatherer = r._createIceGatherer(a, r.usingBundle));
          ...
          (l.prototype.createAnswer = function () {
            ...
            var i = o.writeSessionBoilerplate(
              r._sdpSessionId,
              r._sdpSessionVersion++
            );
            r.usingBundle &&
            ...
            r.transceivers.forEach(function (e, o) {
              if (!(o + 1 > s)) {
                ...
                !d.codecs.filter(function (e) {
                  ...
                  (i += n(e, d, "answer", e.stream, r._dtlsRole)),
                  e.rtcpParameters &&
                  ...
                  if (e && "" !== e.candidate) {
                    ...
                    0 === p.indexOf("a=") && (p = p.substr(2)),
                      ...
                      (r._remoteDescription.sdp =
                        o.getDescription(r._remoteDescription.sdp) +
                        t.join(""));
    ...
    196: function (e, t, r) {
      ...
      function k(e) {
        ...
        if (r.mozGetUserMedia)
          (t.browser = "firefox"),
            (t.version = u(r.userAgent, /Firefox\/(\d+)\./, 1));
        else if (
          ...
          (t.browser = "chrome"),
            (t.version = u(r.userAgent, /Chrom(e|ium)\/(\d+)\./, 2));
        else if (r.mediaDevices && r.userAgent.match(/Edge\/(\d+).(\d+)$/))
          (t.browser = "edge"),
            (t.version = u(r.userAgent, /Edge\/(\d+).(\d+)$/, 2));
        else {
          if (
            !e.RTCPeerConnection ||
      ...
      function B(e) {
        return C(e)
          ? Object.keys(e).reduce(function (t, r) {
              ...
              return void 0 === n || a
                ? t
                : Object.assign(t, Object(c.a)({}, r, n));
            }, {})
          : e;
      }
      function g(e, t, r) {
        ...
        return (
          ...
          a.forEach(function (t) {
            e.forEach(function (r) {
              r.type === o && r.trackId === t.id && g(e, r, n);
            });
          }),
          n
        );
                      ...
                      return (
                        ...
                        r &&
                          (e.video.deviceId = i.exact
                            ...
                            : { ideal: r.deviceId }),
                        (e.video = o(e.video)),
                        P("chrome: " + JSON.stringify(e)),
                        n(e)
                      );
                    });
                e.video = o(e.video);
              }
              return P("chrome: " + JSON.stringify(e)), n(e);
            },
            a = function (e) {
              return t.version >= 64
                ? e
        ...
        if (e.RTCPeerConnection) {
          ...
          e.RTCPeerConnection.prototype.getStats = function () {
            var e = this,
              ...
              n = r[1],
              a = r[2];
            if (arguments.length > 0 && "function" === typeof o)
      ...
      var he = (function () {
        ...
        switch (d.browser) {
          case "chrome":
            if (!o || !L || !r.shimChrome)
              return (
                c("Chrome shim is not included in this adapter release."), l
              );
            if (null === d.version)
              return (
                c("Chrome shim can not determine version, not shimming."), l
              );
          ...
          case "firefox":
            if (!a || !V || !r.shimFirefox)
              return (
                c("Firefox shim is not included in this adapter release."), l
              );
          ...
          case "edge":
            if (!n || !A || !r.shimEdge)
              return (
                c("MS edge shim is not included in this adapter release."), l
              );
          ...
          case "safari":
            if (!i || !r.shimSafari)
              return (
                c("Safari shim is not included in this adapter release."), l
              );
...
//# sourceMappingURL=6.cf0b6541.chunk.js.map
