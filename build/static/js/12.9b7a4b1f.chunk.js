(this['webpackJsonpmaqshaf-pkr-web'] = this['webpackJsonpmaqshaf-pkr-web'] || []).push([
  ...
  Array(141).concat([
    ...
    function (e, t, r) {
      ...
      var o = r(1),
        ...
        d = n.forwardRef(function (e, t) {
          ...
          return n.createElement(
            ...
            Object(o.a)(
              {
                className: Object(s.a)(
                  a.root,
                  c,
                  'inherit' !== u && a['color'.concat(Object(l.a)(u))],
                  'default' !== h && 'medium' !== h && a['fontSize'.concat(Object(l.a)(h))]
                ),
                focusable: 'false',
                viewBox: y,
                color: v,
            ...
            r,
            g ? n.createElement('title', null, g) : null
          );
        });
      d.muiName = 'SvgIcon';
      var u = Object(c.a)(
      ...
      function p(e, t) {
        var r = function (t, r) {
          return a.a.createElement(u, Object(o.a)({ ref: r }, t), e);
        };
        return (r.muiName = u.muiName), a.a.memo(a.a.forwardRef(r));
      }
    },
    ,
    ,
    ...
    function (e, t, r) {
        ...
        u = (function (e) {
          ...
          return (
            ...
            (r.shouldFetchOnReconnect = function () {
              return (
                ...
                !1 !== (t = this.options).enabled &&
                  ('always' === t.refetchOnReconnect || (!1 !== t.refetchOnReconnect && m(e, t)))
              );
              var e, t;
            }),
              ...
              return (
                ...
                !1 !== (t = this.options).enabled &&
                  ('always' === t.refetchOnWindowFocus ||
                    (!1 !== t.refetchOnWindowFocus && m(e, t)))
              );
              var e, t;
            }),
            (r.destroy = function () {
            ...
            (r.setOptions = function (e, t) {
              ...
              n && f(this.currentQuery, o, this.options, r) && this.executeFetch(),
                this.updateResult(t),
                !n ||
                  (this.currentQuery === o &&
            ...
            (r.getNextResult = function (e) {
              ...
              return new Promise(function (r, o) {
                var n = t.subscribe(function (t) {
                  t.isFetching ||
                    (n(), t.isError && (null == e ? void 0 : e.throwOnError) ? o(t.error) : r(t));
                });
              });
            }),
            ...
            (r.fetchOptimistic = function (e) {
              var t = this,
                ...
                o = this.client.getQueryCache().build(this.client, r);
              return o.fetch().then(function () {
                return t.createResult(o, r);
              });
            }),
            (r.fetch = function (e) {
              var t = this;
            ...
            (r.createResult = function (e, t) {
              var r,
                ...
                h = d ? this.currentResult : this.previousQueryResult,
                v = e.state,
                g = v.dataUpdatedAt,
                w = v.error,
                y = v.errorUpdatedAt,
              ...
              if (
                ...
                (r = h.data), (g = h.dataUpdatedAt), (C = h.status), (b = !0);
              else if (t.select && 'undefined' !== typeof v.data)
                if (
                  i &&
                  v.data === (null == s ? void 0 : s.data) &&
              ...
              if (
                ...
                if (
                  ...
                  try {
                    (T = t.select(T)),
                      !1 !== t.structuralSharing &&
                        (T = Object(a.n)(null == i ? void 0 : i.data, T)),
                      (this.previousSelectError = null);
                  } catch (R) {
                    Object(l.a)().error(R),
                      (w = R),
                ...
                'undefined' !== typeof T && ((C = 'success'), (r = T), (B = !0));
              }
              return {
                status: C,
                isLoading: 'loading' === C,
                ...
                isFetchedAfterMount:
                  v.dataUpdateCount > u.dataUpdateCount || v.errorUpdateCount > u.errorUpdateCount,
                isFetching: k,
                isLoadingError: 'error' === C && 0 === v.dataUpdatedAt,
                isPlaceholderData: B,
                isPreviousData: b,
                isRefetchError: 'error' === C && 0 !== v.dataUpdatedAt,
                isStale: m(e, t),
            ...
            (r.shouldNotifyListeners = function (e, t) {
              ...
              var a = 'tracked' === o ? this.trackedProps : o;
        ...
        return (
          ...
          (function (e, t) {
            return (
              ...
              ('always' === t.refetchOnMount || (!1 !== t.refetchOnMount && m(e, t)))
            );
          })(e, t)
        );
      }
      function f(e, t, r, o) {
        return !1 !== r.enabled && (e !== t || !1 === o.enabled) && m(e, r);
      }
      function m(e, t) {
      ...
      function k(e, t) {
        var r = v.a.useRef(!1),
          ...
          n = Object(y.b)(),
          a = v.a.useContext(w),
          s = n.defaultQueryObserverOptions(e);
        (s.optimisticResults = !0),
          s.onError && (s.onError = i.a.batchCalls(s.onError)),
          s.onSuccess && (s.onSuccess = i.a.batchCalls(s.onSuccess)),
          s.onSettled && (s.onSettled = i.a.batchCalls(s.onSettled)),
          s.suspense && 'number' !== typeof s.staleTime && (s.staleTime = 1e3),
          (s.suspense || s.useErrorBoundary) && (a.isReset() || (s.retryOnMount = !1));
        var c = v.a.useState(function () {
            return new t(n, s);
          })[0],
        ...
        if ((s.suspense || s.useErrorBoundary) && l.isError && !l.isFetching) throw l.error;
        return 'tracked' === s.notifyOnChangeProps && (l = c.trackResult(l)), l;
      }
      function C(e, t, r) {
        return k(Object(a.l)(e, t, r), u);
      }
    },
    ,
    ,
    ...
    function (e, t, r) {
      ...
      (e.exports = (function () {
        ...
        var e = Object.freeze({
          ...
          b = function (e) {
            return e instanceof Element || C(e);
          },
          B = function (e) {
            var t = {};
            return (
              'object' !== typeof e[0] || b(e[0])
          ...
          T = S(['success', 'warning', 'info', 'question', 'error']),
          R = function () {
          ...
          I = function () {
            return O(x['html-container']);
          },
          j = function () {
            return O(x.image);
          },
          D = function () {
            return O(x['progress-steps']);
          },
          A = function () {
            return O(x['validation-message']);
          },
          N = function () {
            return E('.'.concat(x.actions, ' .').concat(x.confirm));
          },
          z = function () {
            return E('.'.concat(x.actions, ' .').concat(x.deny));
          },
          F = function () {
            return O(x['input-label']);
          },
          U = function () {
            return E('.'.concat(x.loader));
          },
          V = function () {
            return E('.'.concat(x.actions, ' .').concat(x.cancel));
          },
          G = function () {
            return O(x.actions);
          },
          ...
          W = function () {
            var e = u(
              ...
              t = u(M().querySelectorAll(Q)).filter(function (e) {
                return '-1' !== e.getAttribute('tabindex');
              });
            return r(e.concat(t)).filter(function (e) {
              return me(e);
            });
          },
          J = function () {
          ...
          Y = function (e, t) {
            if (((e.textContent = ''), t)) {
              ...
              u(r.querySelector('head').childNodes).forEach(function (t) {
                e.appendChild(t);
              }),
                u(r.querySelector('body').childNodes).forEach(function (t) {
                  e.appendChild(t);
                });
            }
          },
          ee = function (e, t) {
            if (!t) return !1;
            for (var r = t.split(/\s+/), o = 0; o < r.length; o++)
              if (!e.classList.contains(r[o])) return !1;
            return !0;
          },
          te = function (e, t) {
            u(e.classList).forEach(function (r) {
              Object.values(x).includes(r) ||
                Object.values(T).includes(r) ||
                Object.values(t.showClass).includes(r) ||
                e.classList.remove(r);
            });
          },
          re = function (e, t, r) {
            if ((te(e, t), t.customClass && t.customClass[r])) {
              if ('string' !== typeof t.customClass[r] && !t.customClass[r].forEach)
                return p(
                  'Invalid type of customClass.'
                    .concat(r, '! Expected string or iterable object, got "')
                    .concat(typeof t.customClass[r], '"')
                );
              ie(e, t.customClass[r]);
            }
          },
          oe = function (e, t) {
            if (!t) return null;
          ...
          ce = function (e, t) {
            for (var r = 0; r < e.childNodes.length; r++)
              if (ee(e.childNodes[r], t)) return e.childNodes[r];
          },
          le = function (e, t, r) {
            r === ''.concat(parseInt(r)) && (r = parseInt(r)),
              r || 0 === parseInt(r)
                ? (e.style[t] = 'number' === typeof r ? ''.concat(r, 'px') : r)
          ...
          Be = function () {
            Vo.isVisible() && Vo.resetValidationMessage();
          },
          Pe = function () {
            var e = M(),
              t = ce(e, x.input),
              r = ce(e, x.file),
              o = e.querySelector('.'.concat(x.range, ' input')),
              n = e.querySelector('.'.concat(x.range, ' output')),
              a = ce(e, x.select),
              i = e.querySelector('.'.concat(x.checkbox, ' input')),
              s = ce(e, x.textarea);
            (t.oninput = Be),
              (r.onchange = Be),
              (a.onchange = Be),
          ...
          Te = function (e) {
            'rtl' === window.getComputedStyle(e).direction && ie(R(), x.rtl);
          },
          Re = function (e) {
            var t = be();
            if (ke()) f('SweetAlert2 requires document to initialize');
            else {
              var r = document.createElement('div');
              (r.className = x.container), t && ie(r, x['no-transition']), Y(r, Ce);
              var o = Se(e.target);
              o.appendChild(r), xe(e), Te(o), Pe();
            }
          },
          Ee = function (e, t) {
          ...
          Oe = function (e, t) {
            e.jquery ? Me(t, e) : Y(t, e.toString());
          },
          Me = function (e, t) {
            if (((e.textContent = ''), 0 in t))
              for (var r = 0; r in t; r++) e.appendChild(t[r].cloneNode(!0));
          ...
          _e = (function () {
            ...
            for (var r in t)
              if (Object.prototype.hasOwnProperty.call(t, r) && 'undefined' !== typeof e.style[r])
                return t[r];
            return !1;
          })(),
          Le = function () {
          ...
          Ie = function (e, t) {
            var r = G(),
              ...
              a = z(),
              i = V();
            t.showConfirmButton || t.showDenyButton || t.showCancelButton ? de(r) : ue(r),
              re(r, t, 'actions'),
              De(n, 'confirm', t),
              De(a, 'deny', t),
              De(i, 'cancel', t),
              je(n, a, i, t),
              t.reverseButtons &&
                (r.insertBefore(i, o), r.insertBefore(a, o), r.insertBefore(n, o)),
              Y(o, t.loaderHtml),
              re(o, t, 'loader');
          };
        function je(e, t, r, o) {
          if (!o.buttonsStyling) return se([e, t, r], x.styled);
          ie([e, t, r], x.styled),
            o.confirmButtonColor &&
              ((e.style.backgroundColor = o.confirmButtonColor), ie(e, x['default-outline'])),
            o.denyButtonColor &&
              ((t.style.backgroundColor = o.denyButtonColor), ie(t, x['default-outline'])),
            o.cancelButtonColor &&
              ((r.style.backgroundColor = o.cancelButtonColor), ie(r, x['default-outline']));
        }
        function De(e, t, r) {
          fe(e, r['show'.concat(d(t), 'Button')], 'inline-block'),
            Y(e, r[''.concat(t, 'ButtonText')]),
            e.setAttribute('aria-label', r[''.concat(t, 'ButtonAriaLabel')]),
            (e.className = x[t]),
            re(e, r, ''.concat(t, 'Button')),
            ie(e, r[''.concat(t, 'ButtonClass')]);
        }
        function Ae(e, t) {
          'string' === typeof t
            ? (e.style.background = t)
            : t || ie([document.documentElement, document.body], x['no-backdrop']);
        }
        function Ne(e, t) {
          t in x
            ? ie(e, x[t])
            : (p('The "position" parameter is not valid, defaulting to "center"'), ie(e, x.center));
        }
        function ze(e, t) {
        ...
        var Fe = function (e, t) {
            var r = R();
            r && (Ae(r, t.backdrop), Ne(r, t.position), ze(r, t.grow), re(r, t, 'container'));
          },
          Ue = { promise: new WeakMap(), innerParams: new WeakMap(), domCache: new WeakMap() },
          ...
          Ge = function (e, t) {
            ...
            Ve.forEach(function (e) {
              var o = x[e],
                a = ce(r, o);
              Xe(e, t.inputAttributes), (a.className = o), n && ue(a);
            }),
              t.input && (n && He(t), Qe(t));
          },
          He = function (e) {
          ...
          Xe = function (e, t) {
            var r = oe(M(), e);
            if (r) for (var o in (qe(r), t)) r.setAttribute(o, t[o]);
          },
          Qe = function (e) {
            var t = Ke(e.input);
        ...
        ($e.text =
          ...
          ($e.file = function (e, t) {
            return Je(e, e, t), We(e, t), e;
          }),
          ($e.range = function (e, t) {
            var r = e.querySelector('input'),
              o = e.querySelector('output');
            return (
              (r.value = t.inputValue), (r.type = t.input), (o.value = t.inputValue), Je(r, e, t), e
            );
          }),
          ($e.select = function (e, t) {
            if (((e.textContent = ''), t.inputPlaceholder)) {
              var r = document.createElement('option');
              Y(r, t.inputPlaceholder),
                (r.value = ''),
                (r.disabled = !0),
                (r.selected = !0),
                e.appendChild(r);
          ...
          ($e.checkbox = function (e, t) {
            var r = oe(M(), 'checkbox');
            (r.value = 1), (r.id = x.checkbox), (r.checked = Boolean(t.inputValue));
            var o = e.querySelector('span');
            return Y(o, t.inputPlaceholder), e;
          }),
          ($e.textarea = function (e, t) {
            (e.value = t.inputValue), We(e, t), Je(e, e, t);
            var r = function (e) {
              return (
            ...
            return (
              setTimeout(function () {
                if ('MutationObserver' in window) {
                  var t = parseInt(window.getComputedStyle(M()).width);
                  new MutationObserver(function () {
                    var o = e.offsetWidth + r(e);
                    M().style.width = o > t ? ''.concat(o, 'px') : null;
        ...
        var Ze = function (e, t) {
            var r = I();
            re(r, t, 'htmlContainer'),
              t.html
                ? (Ee(t.html, r), de(r, 'block'))
                : t.text
                ? ((r.textContent = t.text), de(r, 'block'))
                : ue(r),
              Ge(e, t);
          },
          Ye = function (e, t) {
            var r = H();
            fe(r, t.footer), t.footer && Ee(t.footer, r), re(r, t, 'footer');
          },
          et = function (e, t) {
            var r = X();
            Y(r, t.closeButtonHtml),
              re(r, t, 'closeButton'),
              fe(r, t.showCloseButton),
              r.setAttribute('aria-label', t.closeButtonAriaLabel);
          },
          tt = function (e, t) {
            var r = Ue.innerParams.get(e),
              o = _();
            return r && t.icon === r.icon
              ? (nt(o, t), void rt(o, t))
              : t.icon || t.iconHtml
              ? t.icon && -1 === Object.keys(T).indexOf(t.icon)
                ? (f(
                  ...
                  ue(o))
                : (de(o), nt(o, t), rt(o, t), void ie(o, t.showClass.icon))
              : ue(o);
          },
          rt = function (e, t) {
            for (var r in T) t.icon !== r && se(e, T[r]);
            ie(e, T[t.icon]), at(e, t), ot(), re(e, t, 'icon');
          },
          ot = function () {
            for (
              var e = M(),
          ...
          nt = function (e, t) {
            (e.textContent = ''),
              t.iconHtml
                ...
                : Y(e, it({ question: '?', warning: '!', info: 'i' }[t.icon]));
          },
          at = function (e, t) {
            if (t.iconColor) {
          ...
          st = function (e, t) {
            var r = j();
            if (!t.imageUrl) return ue(r);
            de(r, ''),
              r.setAttribute('src', t.imageUrl),
              r.setAttribute('alt', t.imageAlt),
              le(r, 'width', t.imageWidth),
              le(r, 'height', t.imageHeight),
              (r.className = x.image),
              re(r, t, 'image');
          },
          ct = function (e) {
            var t = document.createElement('li');
            return ie(t, x['progress-step']), Y(t, e), t;
          },
          lt = function (e) {
            var t = document.createElement('li');
            return (
          ...
          dt = function (e, t) {
            var r = D();
            if (!t.progressSteps || 0 === t.progressSteps.length) return ue(r);
            de(r),
              (r.textContent = ''),
              ...
              t.progressSteps.forEach(function (e, o) {
                ...
                if (
                  (r.appendChild(n),
                  o === t.currentProgressStep && ie(n, x['active-progress-step']),
          ...
          ut = function (e, t) {
            var r = L();
            fe(r, t.title || t.titleText, 'block'),
              t.title && Ee(t.title, r),
          ...
          pt = function (e, t) {
            var r = R(),
              o = M();
            t.toast
              ? (le(r, 'width', t.width), (o.style.width = '100%'), o.insertBefore(U(), _()))
              : le(o, 'width', t.width),
          ...
          ft = function (e, t) {
            (e.className = ''.concat(x.popup, ' ').concat(me(e) ? t.showClass.popup : '')),
              t.toast
                ? (ie([document.documentElement, document.body], x['toast-shown']), ie(e, x.toast))
                : ie(e, x.modal),
              re(e, t, 'popup'),
          ...
          mt = function (e, t) {
            pt(e, t),
              ...
              Ie(e, t),
              Ye(e, t),
              'function' === typeof t.didRender && t.didRender(M());
          },
          ht = function () {
            return me(M());
          },
        ...
        function yt() {
          for (var e = this, t = arguments.length, r = new Array(t), o = 0; o < t; o++)
            r[o] = arguments[o];
          return l(e, r);
        }
        function kt(e) {
          return (function (t) {
            ...
            var r = c(l);
            function l() {
              return o(this, l), r.apply(this, arguments);
            }
            return (
              n(l, [
                {
                  key: '_main',
                  value: function (t, r) {
                    return a(i(l.prototype), '_main', this).call(this, t, Object.assign({}, e, r));
                  },
                },
              ]),
              l
        ...
        var Ct = function (e) {
          ...
          bt = function (e, t) {
            ...
            !t && me(N()) && (t = N()),
              de(r),
              t && (ue(t), o.setAttribute('data-button-to-replace', t.className)),
          ...
          St = function () {
            Pt.previousActiveElement && Pt.previousActiveElement.focus
              ? (Pt.previousActiveElement.focus(), (Pt.previousActiveElement = null))
          ...
          Rt = function () {
            if (Pt.timeout) return ye(), Pt.timeout.stop();
          },
          Et = function () {
            if (Pt.timeout) {
              var e = Pt.timeout.start();
              return we(e), e;
            }
          },
          Ot = function () {
            var e = Pt.timeout;
            return e && (e.running ? Rt() : Et());
          },
          Mt = function (e) {
            if (Pt.timeout) {
              var t = Pt.timeout.increase(e);
              return we(t, !0), t;
            }
          },
          _t = function () {
        ...
        function jt() {
          (It[
            ...
            Lt || (document.body.addEventListener('click', Dt), (Lt = !0));
        }
        var Dt = function (e) {
            for (var t = e.target; t && t !== document; t = t.parentNode)
              for (var r in It) {
                var o = t.getAttribute(r);
                if (o) return void It[r].fire({ template: o });
              }
          },
          At = {
            title: '',
          ...
          Ut = function (e) {
            return Object.prototype.hasOwnProperty.call(At, e);
          },
          Vt = function (e) {
          ...
          Ht = function (e) {
            Ut(e) || p('Unknown parameter "'.concat(e, '"'));
          },
          qt = function (e) {
            Ft.includes(e) && p('The parameter "'.concat(e, '" is incompatible with toasts'));
          },
          Xt = function (e) {
            Gt(e) && v(e, Gt(e));
          },
        ...
        var Kt = function (e) {
          ...
          t.length ? de(t[0], 'inline-block') : he() && ue(e.actions);
        };
        function $t(e) {
          var t = Ue.innerParams.get(e || this),
            r = Ue.domCache.get(e || this);
          return r ? oe(r.popup, t.input) : null;
        }
        var Zt = function () {
            null === Z.previousBodyPadding &&
              ...
              (document.body.style.paddingRight = ''.concat(Z.previousBodyPadding + Le(), 'px')));
          },
          Yt = function () {
            null !== Z.previousBodyPadding &&
          ...
          tr = function () {
            if (!navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i)) {
              ...
              M().scrollHeight > window.innerHeight - e &&
                (R().style.paddingBottom = ''.concat(e, 'px'));
            }
          },
          rr = function () {
            var e,
          ...
          lr = { swalPromiseResolve: new WeakMap() };
        function dr(e, t, r, o) {
          K()
            ? vr(e, o)
            : (xt(r).then(function () {
        ...
        function pr(e) {
          ...
          if (t) {
            e = fr(e);
            var r = Ue.innerParams.get(this);
            if (r && !ee(t, r.hideClass.popup)) {
              var o = lr.swalPromiseResolve.get(this);
              se(t, r.showClass.popup), ie(t, r.hideClass.popup);
              var n = R();
              se(n, r.showClass.backdrop), ie(n, r.hideClass.backdrop), mr(this, t, r), o(e);
            }
          }
        }
        var fr = function (e) {
          ...
          mr = function (e, t, r) {
            var o = R(),
              n = _e && ge(t);
            'function' === typeof r.willClose && r.willClose(t),
              n ? hr(e, t, o, r.returnFocus, r.didClose) : dr(e, o, r.returnFocus, r.didClose);
          },
          hr = function (e, t, r, o, n) {
            (Pt.swalCloseEventFinishedCallback = dr.bind(null, e, r, o, n)),
              t.addEventListener(_e, function (e) {
                e.target === t &&
                  (Pt.swalCloseEventFinishedCallback(), delete Pt.swalCloseEventFinishedCallback);
              });
          },
          vr = function (e, t) {
            setTimeout(function () {
        ...
        function wr(e, t) {
          ...
          if ('radio' === e.type)
            for (
              var r = e.parentNode.parentNode.querySelectorAll('input'), o = 0;
              o < r.length;
              o++
            )
              r[o].disabled = t;
        ...
        function Rr(e) {
          e.inputValidator ||
            Object.keys(Tr).forEach(function (t) {
              e.input === t && (e.inputValidator = Tr[t]);
            });
        }
        function Er(e) {
          (!e.target ||
        ...
        var Mr = ['swal-title', 'swal-html', 'swal-footer'],
          _r = function (e) {
            var t =
              'string' === typeof e.template ? document.querySelector(e.template) : e.template;
            if (!t) return {};
            var r = t.content;
            return zr(r), Object.assign(Lr(r), Ir(r), jr(r), Dr(r), Ar(r), Nr(r, Mr));
          },
          Lr = function (e) {
            var t = {};
            return (
              u(e.querySelectorAll('swal-param')).forEach(function (e) {
                Fr(e, ['name', 'value']);
                var r = e.getAttribute('name'),
                  o = e.getAttribute('value');
                'boolean' === typeof At[r] && 'false' === o && (o = !1),
                  'object' === typeof At[r] && (o = JSON.parse(o)),
                  (t[r] = o);
              }),
              t
            );
          ...
          jr = function (e) {
            ...
            return (
              r &&
                (Fr(r, ['src', 'width', 'height', 'alt']),
                r.hasAttribute('src') && (t.imageUrl = r.getAttribute('src')),
                r.hasAttribute('width') && (t.imageWidth = r.getAttribute('width')),
                r.hasAttribute('height') && (t.imageHeight = r.getAttribute('height')),
                r.hasAttribute('alt') && (t.imageAlt = r.getAttribute('alt'))),
              t
            );
          },
          Dr = function (e) {
          ...
          Ar = function (e) {
            ...
            r &&
              (Fr(r, ['type', 'label', 'placeholder', 'value']),
          ...
          Nr = function (e, t) {
            ...
            for (var o in t) {
              var n = t[o],
                a = e.querySelector(n);
              a && (Fr(a, []), (r[n.replace(/^swal-/, '')] = a.innerHTML.trim()));
            }
            return r;
          },
          zr = function (e) {
            ...
            u(e.children).forEach(function (e) {
              var r = e.tagName.toLowerCase();
              -1 === t.indexOf(r) && p('Unrecognized element <'.concat(r, '>'));
            });
          },
          Fr = function (e, t) {
            u(e.attributes).forEach(function (r) {
              -1 === t.indexOf(r.name) &&
                p([
          ...
          Vr = function (e) {
            ...
            Xr(t, r, e),
              ...
              J() && (qr(t, e.scrollbarPadding, o), sr()),
              K() ||
          ...
          Gr = function e(t) {
            ...
            if (t.target === r) {
              var o = R();
              r.removeEventListener(_e, e), (o.style.overflowY = 'auto');
            }
          },
          Hr = function (e, t) {
            _e && ge(t)
              ? ((e.style.overflowY = 'hidden'), t.addEventListener(_e, Gr))
          ...
          Xr = function (e, t, r) {
            ie(e, r.showClass.backdrop),
              t.style.setProperty('opacity', '0', 'important'),
              de(t, 'grid'),
              setTimeout(function () {
                ie(t, r.showClass.popup), t.style.removeProperty('opacity');
              }, Ur),
          ...
          Zr = function (e, t) {
            var r = M(),
              o = function (e) {
                return eo[t.input](r, to(e), t);
              };
            w(t.inputOptions) || k(t.inputOptions)
              ? (Ct(N()),
                y(t.inputOptions).then(function (t) {
                  e.hideLoading(), o(t);
                }))
          ...
          Yr = function (e, t) {
            ...
            ue(r),
              y(t.inputValue)
                .then(function (o) {
                  (r.value = 'number' === t.input ? parseFloat(o) || 0 : ''.concat(o)),
                    de(r),
                    r.focus(),
                    e.hideLoading();
                })
            ...
            select: function (e, t, r) {
              var o = ce(e, x.select),
                n = function (e, t, o) {
                  ...
                  (n.value = o), Y(n, t), (n.selected = ro(o, r.inputValue)), e.appendChild(n);
                };
              t.forEach(function (e) {
                var t = e[0],
                  r = e[1];
            ...
            return (
              'undefined' !== typeof Map && t instanceof Map
                ? t.forEach(function (t, o) {
                    var n = t;
                    'object' === typeof n && (n = e(n)), r.push([o, n]);
                  })
          ...
          oo = function (e) {
            ...
            e.disableButtons(), t.input ? io(e, 'confirm') : uo(e, !0);
          },
          no = function (e) {
            var t = Ue.innerParams.get(e);
            e.disableButtons(), t.returnInputValueOnDeny ? io(e, 'deny') : co(e, !1);
          },
          ao = function (t, r) {
            t.disableButtons(), r(e.cancel);
          },
          io = function (e, t) {
            var r = Ue.innerParams.get(e),
              o = Wr(e, r);
            r.inputValidator
              ...
              ? 'deny' === t
                ? co(e, o)
                : uo(e, o)
              : (e.enableButtons(), e.showValidationMessage(r.validationMessage));
          },
          so = function (e, t, r) {
            var o = Ue.innerParams.get(e);
            e.disableInput(),
              Promise.resolve()
                .then(function () {
                  return y(o.inputValidator(t, o.validationMessage));
                })
                .then(function (o) {
                  e.enableButtons(),
                    e.enableInput(),
                    o ? e.showValidationMessage(o) : 'deny' === r ? co(e, t) : uo(e, t);
                });
          },
          co = function (e, t) {
            var r = Ue.innerParams.get(e || void 0);
            r.showLoaderOnDeny && Ct(z()),
              r.preDeny
                ? Promise.resolve()
                    .then(function () {
                      return y(r.preDeny(t, r.validationMessage));
                    })
                    .then(function (r) {
                      !1 === r
                        ? e.hideLoading()
                        : e.closePopup({ isDenied: !0, value: 'undefined' === typeof r ? t : r });
                    })
          ...
          uo = function (e, t) {
            var r = Ue.innerParams.get(e || void 0);
            r.showLoaderOnConfirm && Ct(),
              r.preConfirm
                ? (e.resetValidationMessage(),
                  Promise.resolve()
                    .then(function () {
                      return y(r.preConfirm(t, r.validationMessage));
                    })
                    .then(function (r) {
                      me(A()) || !1 === r
                        ? e.hideLoading()
                        : lo(e, 'undefined' === typeof r ? t : r);
                    }))
                : lo(e, t);
          },
          po = function (e, t, r, o) {
            t.keydownTarget &&
              ...
              r.toast ||
                ...
                (t.keydownTarget = r.keydownListenerCapture ? window : M()),
          ...
          fo = function (e, t, r) {
            var o = W();
            if (o.length)
              return (t += r) === o.length ? (t = 0) : -1 === t && (t = o.length - 1), o[t].focus();
            M().focus();
          },
          ...
          vo = function (e, t, r) {
            ...
            o &&
              ...
              'Enter' === t.key
                ...
                : 'Tab' === t.key
                ? wo(t, o)
                : [].concat(mo, ho).includes(t.key)
                ? yo(t.key)
                : 'Escape' === t.key && ko(t, o, r));
          },
          go = function (e, t, r) {
            if (
              !t.isComposing &&
          ...
          wo = function (e, t) {
            for (var r = e.target, o = W(), n = -1, a = 0; a < o.length; a++)
              if (r === o[a]) {
                n = a;
                break;
              }
            e.shiftKey ? fo(t, n, -1) : fo(t, n, 1), e.stopPropagation(), e.preventDefault();
          },
          yo = function (e) {
            if ([N(), z(), V()].includes(document.activeElement)) {
              var t = mo.includes(e) ? 'nextElementSibling' : 'previousElementSibling',
                r = document.activeElement[t];
              r && r.focus();
            }
          },
          ko = function (t, r, o) {
            g(r.allowEscapeKey) && (t.preventDefault(), o(e.esc));
          },
          Co = function (e, t, r) {
            Ue.innerParams.get(e).toast ? bo(e, t, r) : (Po(t), So(t), xo(e, t, r));
          },
          bo = function (t, r, o) {
            r.popup.onclick = function () {
              var r = Ue.innerParams.get(t);
              r.showConfirmButton ||
                r.showDenyButton ||
                r.showCancelButton ||
                r.showCloseButton ||
          ...
          Po = function (e) {
            e.popup.onmousedown = function () {
              e.container.onmouseup = function (t) {
                (e.container.onmouseup = void 0), t.target === e.container && (Bo = !0);
              };
            };
          },
          So = function (e) {
            e.container.onmousedown = function () {
              e.popup.onmouseup = function (t) {
                (e.popup.onmouseup = void 0),
                  (t.target === e.popup || e.popup.contains(t.target)) && (Bo = !0);
              };
            };
          },
          xo = function (t, r, o) {
            r.container.onclick = function (n) {
              ...
              Bo ? (Bo = !1) : n.target === r.container && g(a.allowOutsideClick) && o(e.backdrop);
            };
          };
        function To(e) {
          var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
          Qt(Object.assign({}, t, e)),
            Pt.currentInstance && Pt.currentInstance._destroy(),
            (Pt.currentInstance = this);
          var r = Ro(e, t);
          Or(r),
            Object.freeze(r),
          ...
          var o = Oo(this);
          return mt(this, r), Ue.innerParams.set(this, r), Eo(this, o, r);
        }
        var Ro = function (e, t) {
            var r = _r(e),
              o = Object.assign({}, At, t, r, e);
            return (
              (o.showClass = Object.assign({}, At.showClass, o.showClass)),
              (o.hideClass = Object.assign({}, At.hideClass, o.hideClass)),
              o
            );
          },
          Eo = function (t, r, o) {
          ...
          _o = function (e, t) {
            if (!t.toast) return g(t.allowEnterKey) ? void (Lo(e, t) || fo(t, -1, 1)) : Io();
          },
          Lo = function (e, t) {
        ...
        function jo(e) {
          var t = M(),
            r = Ue.innerParams.get(this);
          if (!t || ee(t, r.hideClass.popup))
            return p(
              "You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup."
            );
          var o = {};
          Object.keys(e).forEach(function (t) {
            Vo.isUpdatableParameter(t)
              ? (o[t] = e[t])
              : p(
        ...
        function Do() {
          ...
          t &&
            (e.popup &&
              Pt.swalCloseEventFinishedCallback &&
              (Pt.swalCloseEventFinishedCallback(), delete Pt.swalCloseEventFinishedCallback),
            Pt.deferDisposalTimer &&
              (clearTimeout(Pt.deferDisposalTimer), delete Pt.deferDisposalTimer),
            'function' === typeof t.didDestroy && t.didDestroy(),
            No(this));
        }
        var Ao,
          No = function (e) {
            delete e.params, delete Pt.keydownHandler, delete Pt.keydownTarget, zo(Ue), zo(lr);
          },
          zo = function (e) {
          ...
          Fo = Object.freeze({
            ...
            enableInput: Cr,
            disableInput: br,
            showValidationMessage: Br,
            resetValidationMessage: Pr,
            getProgressSteps: Sr,
            _main: To,
            update: jo,
            _destroy: Do,
        ...
        Object.assign(Uo.prototype, Fo),
          Object.assign(Uo, Wt),
          Object.keys(Fo).forEach(function (e) {
            Uo[e] = function () {
              var t;
              if (Ao) return (t = Ao)[e].apply(t, arguments);
            };
          }),
          (Uo.DismissReason = e),
          (Uo.version = '11.1.0');
        ...
        'undefined' != typeof document &&
          (function (e, t) {
            ...
            if ((e.getElementsByTagName('head')[0].appendChild(r), r.styleSheet))
      ...
      e.exports = (function (e, t) {
        ...
        function m(e) {
          return (function (t) {
            ...
            var r = c(m);
            function m() {
              return o(this, m), r.apply(this, arguments);
            }
            return (
              n(
                m,
                    ...
                    value: function (t, r) {
                      return (
                        ...
                        u.forEach(function (r) {
                          var o = r.key,
                            n = r.getter;
                          if (l.default.isValidElement(t[o])) {
                            var a,
                              i = t[o];
                            t[o] = ' ';
                            var s = 'didOpen',
                              c = t[s] || p;
                            t[s] = function (t) {
                              (a = n(e)) && d.default.render(i, a), c(t);
                            };
                            var u = 'didDestroy',
                              f = t[u] || p;
                            t[u] = function (e) {
                              f(e), a && d.default.unmountComponentAtNode(a);
                            };
                          }
                        }),
                        a(i(m.prototype), '_main', this).call(this, t, r)
                      );
                    },
                  },
                  {
                ...
                [
                  {
                    key: 'argsToParams',
                    value: function (t) {
                      if (l.default.isValidElement(t[0]) || l.default.isValidElement(t[1])) {
                        var r = {};
                        return (
    ...
    function (e, t, r) {
      ...
      (o.localCName = o.generateIdentifier()),
        ...
        (o.parseFmtp = function (e) {
          for (var t, r = {}, o = e.substr(e.indexOf(' ') + 1).split(';'), n = 0; n < o.length; n++)
            r[(t = o[n].trim().split('='))[0].trim()] = t[1];
          return r;
        }),
        ...
        (o.parseSsrcMedia = function (e) {
          ...
          return (
            o > -1
              ? ((r.attribute = e.substr(t + 1, o - t - 1)), (r.value = e.substr(o + 1)))
        ...
        (o.writeCryptoLine = function (e) {
          return (
            ...
            e.cryptoSuite +
            ' ' +
            ('object' === typeof e.keyParams ? o.writeCryptoKeyParams(e.keyParams) : e.keyParams) +
        ...
        (o.parseRtpParameters = function (e) {
          for (
            var t = { codecs: [], headerExtensions: [], fecMechanisms: [], rtcp: [] },
              r = o.splitLines(e)[0].split(' '),
              n = 3;
            n < r.length;
            n++
          ) {
            var a = r[n],
              i = o.matchPrefix(e, 'a=rtpmap:' + a + ' ')[0];
            if (i) {
              var s = o.parseRtpMap(i),
                c = o.matchPrefix(e, 'a=fmtp:' + a + ' ');
              switch (
                ((s.parameters = c.length ? o.parseFmtp(c[0]) : {}),
                (s.rtcpFeedback = o.matchPrefix(e, 'a=rtcp-fb:' + a + ' ').map(o.parseRtcpFb)),
                t.codecs.push(s),
                s.name.toUpperCase())
              ) {
                case 'RED':
        ...
        (o.parseRtpEncodingParameters = function (e) {
          var t,
            ...
            l = o.matchPrefix(e, 'a=ssrc-group:FID').map(function (e) {
              return e
                .substr(17)
                .split(' ')
                .map(function (e) {
          ...
          l.length > 0 && l[0].length > 1 && l[0][0] === c && (t = l[0][1]),
            n.codecs.forEach(function (e) {
              if ('RTX' === e.name.toUpperCase() && e.parameters.apt) {
                var o = { ssrc: c, codecPayloadType: parseInt(e.parameters.apt, 10) };
                c && t && (o.rtx = { ssrc: t }),
                  r.push(o),
                  a &&
                    (((o = JSON.parse(JSON.stringify(o))).fec = {
                      ssrc: c,
        ...
        (o.parseSctpDescription = function (e) {
          ...
          if (o.matchPrefix(e, 'a=sctpmap:').length > 0) {
            var i = o.matchPrefix(e, 'a=sctpmap:')[0].substr(10).split(' ');
        ...
        (o.writeMediaSection = function (e, t, r, n) {
          ...
          return (
            (a += 'a=ssrc:' + e.sendEncodingParameters[0].ssrc + ' cname:' + o.localCName + '\r\n'),
            e.rtpSender &&
              e.sendEncodingParameters[0].rtx &&
              (a +=
                'a=ssrc:' +
    ...
    function (e, t, r) {
        ...
        d = (function (e) {
          ...
          return (
            ...
            (r.updateResult = function () {
              var e = this.currentMutation ? this.currentMutation.state : Object(l.b)();
      ...
      function p(e, t, r) {
        var n = a.a.useRef(!1),
          ...
          p = Object(u.b)(),
          f = a.a.useRef();
        f.current ? f.current.setOptions(l) : (f.current = new d(p, l));
    ...
    function (e, t, r) {
      var o = r(265),
        n = r(304);
      e.exports = function (e, t) {
        for (var r = 0, a = (t = o(t, e)).length; null != e && r < a; ) e = e[n(t[r++])];
    ...
    function (e, t, r) {
      ...
      e.exports = function (e) {
        return !(!a(e) || n(e)) && (o(e) ? p : s).test(i(e));
      };
    },
    function (e, t, r) {
      var o = r(224),
    ...
    function (e, t, r) {
      var o = r(195)['__core-js_shared__'];
      e.exports = o;
    },
    function (e, t) {
    ...
    function (e, t, r) {
      ...
      var s = r(0),
        ...
        d = r(306),
        u = d.getDeviceId,
        p = (d.getFacingModePattern, r(308)),
        f = r(309);
      r(312);
      var m = f(
          [
            ...
            return (
              ...
              i(t, [
                ...
                },
                {
                  ...
                  value: function () {
                    var e =
                        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.props,
                      t = e.onError,
                      r = e.facingMode,
                    ...
                    navigator.mediaDevices &&
                      ...
                      (n = navigator.mediaDevices.getSupportedConstraints());
                    var a = {};
                    n.facingMode && (a.facingMode = { ideal: r }),
                      n.frameRate && (a.frameRate = { ideal: 25, min: 10 });
                    var i =
                      n.facingMode || o
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    void 0 !== (t || {}).srcObject
                      ...
                      (t.playsInline = !0);
                    var o = e.getTracks()[0];
                    (this.stopCamera = o.stop.bind(o)),
                      t.addEventListener('loadstart', this.handleLoadStart),
                      this.setState({ mirrorVideo: 'user' == r, streamLabel: o.label });
                  },
                },
                {
                  key: 'handleLoadStart',
                  value: function () {
                    var e = this.props,
                      ...
                      i = this.els.preview;
                    i.play(),
                      'function' == typeof r && r({ mirrorVideo: n, streamLabel: a }),
                  ...
                  value: function (e) {
                    ...
                    r(e.data || null),
                      !o &&
                        'number' == typeof n &&
                        this.worker &&
                        (this.timeout = setTimeout(this.check, n));
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    return s.createElement(
                      ...
                      s.createElement(
                        ...
                        s.createElement('canvas', { style: c, ref: this.setRefFactory('canvas') })
                      )
                    );
                  },
                },
    ...
    function (e, t, r) {
      'use strict';
      var o = r(307).NoVideoInputDevicesError;
      function n(e, t, r) {
        return e.length > 0
          ? e[0].deviceId
          : 1 == t.length || 'user' == r
    ...
    function (e, t, r) {
      ...
      (o.prototype = new Error()), (e.exports = { NoVideoInputDevicesError: o });
    },
    function (e, t, r) {
      'use strict';
      e.exports = function (e, t, r) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n, a) {
        ...
        return (
          (i += 'a=ssrc:' + e.sendEncodingParameters[0].ssrc + ' cname:' + o.localCName + '\r\n'),
          e.rtpSender &&
            e.sendEncodingParameters[0].rtx &&
            (i +=
              'a=ssrc:' + e.sendEncodingParameters[0].rtx.ssrc + ' cname:' + o.localCName + '\r\n'),
          i
        );
      }
      function a(e, t) {
      ...
      e.exports = function (e, t) {
        ...
        var d = function (r) {
          ...
          (this._config = r),
            (this.transceivers = []),
            (this._sdpSessionId = o.generateSessionId()),
        ...
        Object.defineProperty(d.prototype, 'localDescription', {
                ...
                (a.onlocalcandidate = function (e) {
                  if (!(n.usingBundle && r > 0)) {
                    ...
                    if (c)
                      ...
                      var l = o.writeCandidate(s);
                      (i.candidate = Object.assign(i.candidate, o.parseCandidate(l))),
                    ...
                    var d = o.getMediaSections(n._localDescription.sdp);
                    (d[i.candidate.sdpMLineIndex] += c
                      ? 'a=end-of-candidates\r\n'
                      : 'a=' + i.candidate.candidate + '\r\n'),
                      (n._localDescription.sdp =
                        o.getDescription(n._localDescription.sdp) + d.join(''));
          ...
          (d.prototype._createIceAndDtlsTransports = function () {
            ...
            return (
              ...
              (o.onerror = function () {
                Object.defineProperty(o, 'state', { value: 'failed', writable: !0 }),
                  t._updateConnectionState();
              }),
          ...
          (d.prototype._transceive = function (e, r, n) {
            ...
            r &&
              ...
              (i.rtcp = { cname: o.localCName, compound: e.rtcpParameters.compound }),
          ...
          (d.prototype.setLocalDescription = function (e) {
            ...
            if (!i('setLocalDescription', e.type, n.signalingState) || n._isClosed)
            ...
            if ('offer' === e.type)
              ...
              (t = o.splitSections(n._remoteDescription.sdp)), (r = t.shift());
              var s = o.matchPrefix(r, 'a=ice-lite').length > 0;
              t.forEach(function (e, t) {
                ...
                if (
                  !(o.isRejected(e) && 0 === o.matchPrefix(e, 'a=bundle-only').length) &&
                  !i.rejected
                ) {
                  var f = o.getIceParameters(e, r),
                    m = o.getDtlsParameters(e, r);
                  s && (m.role = 'server'),
                    (n.usingBundle && 0 !== t) ||
                      (n._gather(i.mid, t),
                      'new' === l.state && l.start(c, f, s ? 'controlling' : 'controlled'),
                      'new' === d.state && d.start(m));
                  var h = a(u, p);
                  n._transceive(i, h.codecs.length > 0, !1);
                }
              });
            }
            return (
          ...
          (d.prototype.setRemoteDescription = function (n) {
            ...
            if (-1 === ['offer', 'answer'].indexOf(n.type))
              return Promise.reject(c('TypeError', 'Unsupported type "' + n.type + '"'));
            if (!i('setRemoteDescription', n.type, d.signalingState) || d._isClosed)
              return Promise.reject(
                c(
                  'InvalidStateError',
                  'Can not set remote ' + n.type + ' in state ' + d.signalingState
                )
              );
            var u = {};
            ...
            var p = [],
              f = o.splitSections(n.sdp),
              m = f.shift(),
              h = o.matchPrefix(m, 'a=ice-lite').length > 0,
              v = o.matchPrefix(m, 'a=group:BUNDLE ').length > 0;
            d.usingBundle = v;
            var g = o.matchPrefix(m, 'a=ice-options:')[0];
            return (
              (d.canTrickleIceCandidates = !!g && g.substr(14).split(' ').indexOf('trickle') >= 0),
              f.forEach(function (i, c) {
                var l = o.splitLines(i),
                  f = o.getKind(i),
                  g = o.isRejected(i) && 0 === o.matchPrefix(i, 'a=bundle-only').length,
                  w = l[0].substr(2).split(' ')[2],
                  y = o.getDirection(i, m),
                  k = o.parseMsid(i),
                  C = o.getMid(i) || o.generateIdentifier();
                if (g || ('application' === f && ('DTLS/SCTP' === w || 'UDP/DTLS/SCTP' === w)))
                  d.transceivers[c] = { mid: C, kind: f, protocol: w, rejected: !0 };
                else {
                  var b, B, P, S, x, T, R, E, O;
                  !g &&
                    d.transceivers[c] &&
                    d.transceivers[c].rejected &&
                    (d.transceivers[c] = d._createTransceiver(f, !0));
                  var M,
                    _,
                    L = o.parseRtpParameters(i);
                  g ||
                    ((M = o.getIceParameters(i, m)),
                    ((_ = o.getDtlsParameters(i, m)).role = 'client')),
                    (R = o.parseRtpEncodingParameters(i));
                  var I = o.parseRtcpParameters(i),
                    j = o.matchPrefix(i, 'a=end-of-candidates', m).length > 0,
                    D = o
                  ...
                  if (
                    (('offer' === n.type || 'answer' === n.type) &&
                      ...
                      d.transceivers[c].rtpSender &&
                        d.transceivers[c].rtpSender.setTransport(d.transceivers[0].dtlsTransport),
                    ...
                    if ('answer' === n.type && !g) {
                      (B = (b = d.transceivers[c]).iceGatherer),
                        (P = b.iceTransport),
                        (S = b.dtlsTransport),
                        (x = b.rtpReceiver),
                        (T = b.sendEncodingParameters),
                        (E = b.localCapabilities),
                        (d.transceivers[c].recvEncodingParameters = R),
                        (d.transceivers[c].remoteCapabilities = L),
                        (d.transceivers[c].rtcpParameters = I),
                        D.length &&
                          'new' === P.state &&
                          ((!h && !j) || (v && 0 !== c)
                        ...
                        (v && 0 !== c) ||
                          ('new' === P.state && P.start(B, M, 'controlling'),
                        ...
                        d._transceive(
                          b,
                          'sendrecv' === y || 'recvonly' === y,
                          'sendrecv' === y || 'sendonly' === y
                        ),
                        !x || ('sendrecv' !== y && 'sendonly' !== y)
                          ? delete b.rtpReceiver
                          : ((O = x.track),
                            k
                              ? (u[k.stream] || (u[k.stream] = new e.MediaStream()),
                                r(O, u[k.stream]),
                                p.push([O, x, u[k.stream]]))
                              : (u.default || (u.default = new e.MediaStream()),
                                r(O, u.default),
                                p.push([O, x, u.default])));
                    }
                  } else {
                    ((b = d.transceivers[c] || d._createTransceiver(f)).mid = C),
                      b.iceGatherer || (b.iceGatherer = d._createIceGatherer(c, v)),
                      D.length &&
                        ...
                        (!j || (v && 0 !== c)
                          ...
                          : b.iceTransport.setRemoteCandidates(D)),
                      (E = e.RTCRtpReceiver.getCapabilities(f)),
                      t < 15019 &&
                        (E.codecs = E.codecs.filter(function (e) {
                          return 'rtx' !== e.name;
                        })),
                      (T = b.sendEncodingParameters || [{ ssrc: 1001 * (2 * c + 2) }]);
                    var A,
                      N = !1;
                      ...
                      if (
                        ...
                        (O = x.track),
                          (k && '-' === k.stream) ||
                            (k
                              ? (u[k.stream] ||
                                  ((u[k.stream] = new e.MediaStream()),
                                  Object.defineProperty(u[k.stream], 'id', {
                                    get: function () {
                                      return k.stream;
                                    },
                                  })),
                                ...
                                (A = u[k.stream]))
                              : (u.default || (u.default = new e.MediaStream()), (A = u.default))),
                          A && (r(O, A), b.associatedRemoteMediaStreams.push(A)),
                          p.push([O, x, A]);
                    } else
                      b.rtpReceiver &&
                        b.rtpReceiver.track &&
                    ...
                    (b.localCapabilities = E),
                      ...
                      (b.rtpReceiver = x),
                      (b.rtcpParameters = I),
                      (b.sendEncodingParameters = T),
                      (b.recvEncodingParameters = R),
                      d._transceive(d.transceivers[c], !1, N);
                  }
                }
              }),
              void 0 === d._dtlsRole && (d._dtlsRole = 'offer' === n.type ? 'active' : 'passive'),
              ...
              Object.keys(u).forEach(function (t) {
                ...
                if (r.getTracks().length) {
                  if (-1 === d.remoteStreams.indexOf(r)) {
                    ...
                    (o.stream = r),
                      e.setTimeout(function () {
                        d._dispatchEvent('addstream', o);
                      });
                  }
                  p.forEach(function (e) {
                    var t = e[0],
                      o = e[1];
                    r.id === e[2].id && l(d, t, o, [r]);
                  });
                }
              }),
              p.forEach(function (e) {
          ...
          (d.prototype.createOffer = function () {
            ...
            var l = o.writeSessionBoilerplate(r._sdpSessionId, r._sdpSessionVersion++);
            r.transceivers.forEach(function (n, a) {
              var i = n.track,
                s = n.kind,
                c = n.mid || o.generateIdentifier();
              (n.mid = c),
                n.iceGatherer || (n.iceGatherer = r._createIceGatherer(a, r.usingBundle));
              ...
              t < 15019 &&
                ...
                l.headerExtensions.forEach(function (e) {
                  ((n.remoteCapabilities && n.remoteCapabilities.headerExtensions) || []).forEach(
                    function (t) {
                      e.uri === t.uri && (e.id = t.id);
                    }
                  );
                });
              var d = n.sendEncodingParameters || [{ ssrc: 1001 * (2 * a + 1) }];
              i && t >= 15019 && 'video' === s && !d[0].rtx && (d[0].rtx = { ssrc: d[0].ssrc + 1 }),
                n.wantReceive && (n.rtpReceiver = new e.RTCRtpReceiver(n.dtlsTransport, s)),
              ...
              r.transceivers.forEach(function (e, t) {
                (l += n(e, e.localCapabilities, 'offer', e.stream, r._dtlsRole)),
                  (l += 'a=rtcp-rsize\r\n'),
                  !e.iceGatherer ||
                    'new' === r.iceGatheringState ||
                    (0 !== t && r.usingBundle) ||
                    (e.iceGatherer.getLocalCandidates().forEach(function (e) {
                      (e.component = 1), (l += 'a=' + o.writeCandidate(e) + '\r\n');
                    }),
          ...
          (d.prototype.createAnswer = function () {
            ...
            var i = o.writeSessionBoilerplate(r._sdpSessionId, r._sdpSessionVersion++);
            r.usingBundle &&
              (i +=
                'a=group:BUNDLE ' +
                r.transceivers
            ...
            var s = o.getMediaSections(r._remoteDescription.sdp).length;
            r.transceivers.forEach(function (e, o) {
              if (!(o + 1 > s)) {
                ...
                !l.codecs.filter(function (e) {
                  ...
                  (i += n(e, l, 'answer', e.stream, r._dtlsRole)),
            ...
            return e && void 0 === e.sdpMLineIndex && !e.sdpMid
              ...
              : new Promise(function (n, a) {
                  ...
                  if (e && '' !== e.candidate) {
                    ...
                    var u =
                      Object.keys(e.candidate).length > 0 ? o.parseCandidate(e.candidate) : {};
                    ...
                    0 === p.indexOf('a=') && (p = p.substr(2)),
                      ((t = o.getMediaSections(r._remoteDescription.sdp))[i] +=
                        'a=' + (u.type ? p : 'end-of-candidates') + '\r\n'),
                      (r._remoteDescription.sdp =
                        o.getDescription(r._remoteDescription.sdp) + t.join(''));
                  } else for (var f = 0; f < r.transceivers.length && (r.transceivers[f].rejected || (r.transceivers[f].iceTransport.addRemoteCandidate({}), ((t = o.getMediaSections(r._remoteDescription.sdp))[f] += 'a=end-of-candidates\r\n'), (r._remoteDescription.sdp = o.getDescription(r._remoteDescription.sdp) + t.join('')), !r.usingBundle)); f++);
                  n();
                });
          }),
        ...
        return (
          ...
          (u = ['setLocalDescription', 'setRemoteDescription', 'addIceCandidate']).forEach(
            function (e) {
              var t = d.prototype[e];
              d.prototype[e] = function () {
                var e = arguments;
    ...
    function (e, t, r) {
      ...
      r.r(o),
        ...
        r.d(o, 'shimMediaStream', function () {
          return S;
        }),
        r.d(o, 'shimOnTrack', function () {
          return x;
        }),
        r.d(o, 'shimGetSendersWithDtmf', function () {
          return T;
        }),
        r.d(o, 'shimGetStats', function () {
          return R;
        }),
        r.d(o, 'shimSenderReceiverGetStats', function () {
          return E;
        }),
        r.d(o, 'shimAddTrackRemoveTrackWithNative', function () {
          return O;
        }),
        r.d(o, 'shimAddTrackRemoveTrack', function () {
          return M;
        }),
        r.d(o, 'shimPeerConnection', function () {
          return _;
        }),
        r.d(o, 'fixNegotiationNeeded', function () {
          return L;
        });
      var n = {};
      r.r(n),
        ...
        r.d(n, 'shimReplaceTrack', function () {
          return z;
        });
      var a = {};
      r.r(a),
      ...
      function y(e) {
        return w(e)
          ? Object.keys(e).reduce(function (t, r) {
              ...
              return void 0 === n || a ? t : Object.assign(t, Object(c.a)({}, r, n));
            }, {})
          : e;
      }
      function k(e, t, r) {
        ...
        return (
          ...
          a.forEach(function (t) {
            e.forEach(function (r) {
              r.type === o && r.trackId === t.id && k(e, r, n);
            });
          }),
          n
        );
        ...
        if (r.mediaDevices) {
          var o = function (e) {
                ...
                Object.keys(e).forEach(function (r) {
                  if ('require' !== r && 'advanced' !== r && 'mediaSource' !== r) {
                    ...
                    void 0 !== o.exact && 'number' !== typeof o.exact
                      ? ((t.mandatory = t.mandatory || {}), (t.mandatory[n('', r)] = o.exact))
                      : ['min', 'max'].forEach(function (e) {
                          void 0 !== o[e] &&
                            ((t.mandatory = t.mandatory || {}), (t.mandatory[n(e, r)] = o[e]));
                        });
                  }
                }),
            ...
            n = function (e, n) {
                ...
                if (
                  ...
                  if (
                    ...
                    'environment' === i.exact || 'environment' === i.ideal
                      ? (s = ['back', 'rear'])
                      : ('user' !== i.exact && 'user' !== i.ideal) || (s = ['front']),
                    s)
                  )
              ...
              return b('chrome: ' + JSON.stringify(e)), n(e);
            },
            a = function (e) {
              return t.version >= 64
                ? e
        ...
        if (e.RTCPeerConnection) {
          ...
          e.RTCPeerConnection.prototype.getStats = function () {
            var e = this,
              ...
              n = r[1],
              a = r[2];
            if (arguments.length > 0 && 'function' === typeof o) return t.apply(this, arguments);
            if (0 === t.length && (0 === arguments.length || 'function' !== typeof o))
              return t.apply(this, []);
            var i = function (e) {
                var t = {};
                return (
              ...
              if (arguments.length > 0 && arguments[0] instanceof e.MediaStreamTrack) {
                ...
                return (
                  ...
                  this.getReceivers().forEach(function (e) {
                    return e.track === a && (r ? (o = !0) : (r = e)), e.track === a;
                  }),
                  o || (t && r)
                    ? Promise.reject(
                        new DOMException(
      ...
      function M(e, t) {
        if (e.RTCPeerConnection) {
          if (e.RTCPeerConnection.prototype.addTrack && t.version >= 65) return O(e);
            ...
            (e.RTCPeerConnection.prototype.removeTrack = function (e) {
              ...
              (this._streams = this._streams || {}),
                Object.keys(this._streams).forEach(function (o) {
                  r._streams[o].getTracks().find(function (t) {
                    return e.track === t;
                  }) && (t = r._streams[o]);
                }),
                t &&
        ...
        if (
          ((r.getUserMedia = function (e, t, o) {
            v('navigator.getUserMedia', 'navigator.mediaDevices.getUserMedia'),
              r.mediaDevices.getUserMedia(e).then(t, o);
          }),
          ...
          if (o && o.prototype.applyConstraints) {
            var s = o.prototype.applyConstraints;
                ...
                if (t.version < 53 && !a)
                  try {
                    ...
                    e.forEach(function (t, o) {
                      e.set(o, Object.assign({}, t, { type: r[t.type] || t.type }));
                    });
                  }
                return e;
              })
          ...
          if (
            ...
            (e.RTCPeerConnection.prototype.addStream = function (e) {
              ...
              (e.RTCPeerConnection.prototype.addTrack = function (e) {
                for (
                  var r = this, o = arguments.length, n = new Array(o > 1 ? o - 1 : 0), a = 1;
                  a < o;
                  a++
                )
                  n[a - 1] = arguments[a];
      ...
      function re(e) {
        return e && void 0 !== e.video ? Object.assign({}, e, { video: y(e.video) }) : e;
      }
      function oe(e) {
        if (e.RTCPeerConnection) {
        ...
        if (
          ...
          (e.RTCIceCandidate = function (e) {
            if (
              ...
              var r = new t(e),
                o = ce.a.parseCandidate(e.candidate),
                n = Object.assign(r, o);
              return (
                (n.toJSON = function () {
                  return {
      ...
      function de(e, t) {
        if (e.RTCPeerConnection) {
          ...
          var r = function (e) {
              if (!e || !e.sdp) return !1;
              var t = ce.a.splitSections(e.sdp);
              return (
                t.shift(),
                t.some(function (e) {
                  var t = ce.a.parseMLine(e);
            ...
            a = function (e, r) {
              ...
              var n = ce.a.matchPrefix(e.sdp, 'a=max-message-size:');
              return (
                n.length > 0
                  ? (o = parseInt(n[0].substr(19), 10))
          ...
          e.RTCPeerConnection.prototype.setRemoteDescription = function (t) {
            if (t && t.sdp && -1 !== t.sdp.indexOf('\na=extmap-allow-mixed')) {
              ...
              e.RTCSessionDescription && t instanceof e.RTCSessionDescription
                ? (arguments[0] = new e.RTCSessionDescription({ type: t.type, sdp: o }))
                : (t.sdp = o);
            }
      ...
      var he = (function () {
        ...
        switch (l.browser) {
          case 'chrome':
            if (!o || !_ || !r.shimChrome)
              return c('Chrome shim is not included in this adapter release.'), d;
            if (null === l.version)
              return c('Chrome shim can not determine version, not shimming.'), d;
          ...
          case 'firefox':
            if (!a || !G || !r.shimFirefox)
              return c('Firefox shim is not included in this adapter release.'), d;
          ...
          case 'edge':
            if (!n || !N || !r.shimEdge)
              return c('MS edge shim is not included in this adapter release.'), d;
          ...
          case 'safari':
            if (!i || !r.shimSafari)
              return c('Safari shim is not included in this adapter release.'), d;
      ...
      var d = a.forwardRef(function (e, t) {
        ...
        return (
          (k = B
            ? a.createElement(
                'img',
                Object(o.a)({ alt: r, src: h, srcSet: v, sizes: m, className: c.img }, f)
              )
            : null != s
            ? s
            : b && r
            ? r[0]
            : a.createElement(l, { className: c.fallback })),
          a.createElement(
            p,
            Object(o.a)(
              { className: Object(i.a)(c.root, c.system, c[w], d, !B && c.colorDefault), ref: t },
              y
            ),
            k
          )
...
//# sourceMappingURL=12.9b7a4b1f.chunk.js.map
